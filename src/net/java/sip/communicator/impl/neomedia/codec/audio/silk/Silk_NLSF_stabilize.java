 ...
 * 
 * Class "Silk_NLSF_stabilize" is mainly based on 
 *../SILK_SDK_SRC_FLP_v1.0.6/src/SKP_Silk_NLSF_stabilize.c
 */
...
//	            center_freq_Q15 = SKP_LIMIT_32( SKP_RSHIFT_ROUND( (int)NLSF_Q15[ NLSF_Q15_offset + I-1] + (int)NLSF_Q15[ NLSF_Q15_offset + I], 1 ),
//	                min_center_Q15, max_center_Q15 );
	            center_freq_Q15 = Silk_SigProc_FIX.SKP_LIMIT_32( Silk_SigProc_FIX.SKP_RSHIFT_ROUND( (int)NLSF_Q15[ NLSF_Q15_offset + I-1] + (int)NLSF_Q15[ NLSF_Q15_offset + I], 1 ),
		                min_center_Q15, max_center_Q15 );
//	            NLSF_Q15[ NLSF_Q15_offset + I-1] = center_freq_Q15 - SKP_RSHIFT( NDeltaMin_Q15[I], 1 );
...
//	        SKP_Silk_insertion_sort_increasing_all_values(&NLSF_Q15[ NLSF_Q15_offset + 0], L);
