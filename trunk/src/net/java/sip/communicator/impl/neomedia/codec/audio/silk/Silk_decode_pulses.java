 ...
 * 
 * Class "Silk_decode_pulses" is mainly based on 
 *../SILK_SDK_SRC_FLP_v1.0.6/src/SKP_Silk_decode_pulses.c
 */
...
//	                    SKP_Silk_pulses_per_block_CDF[ Silk_define.N_RATE_LEVELS - 1 ], SKP_Silk_pulses_per_block_CDF_offset );
	    ...
	    for( i = 0; i < iter; i++ ) {
	        if( sum_pulses[ i ] > 0 ) {
//	            SKP_Silk_shell_decoder( &q[ SKP_SMULBB( i, Silk_define.SHELL_CODEC_FRAME_LENGTH ) ], psRC, sum_pulses[ i ] );
